...
<html>
<head>
    <title>Ban or Suspend | Admin</title>
    <link rel="stylesheet" type="text/css" href="../css/admin_ban_style.css">
</head>
<body>
    ...
    <div class="sidebar">
        ...
        <a href="admin_ban_controller.php" class="active">Ban or Warning</a>
    ...
    <div class="main-content">
        ...
        <div class="form-card">
            ...
            <form action="admin_ban_controller.php" method="POST">
                <label>User ID:</label>
